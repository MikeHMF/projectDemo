...
- (void)viewDidLoad {
    ...
    self.fontDictionary = [FoundationViewController dictionaryFromResource:@"foundationIcons.json"];
    ...
    for(int i=0;i<self.dataArray.count;i++)
    {
        ...
        UIButton *btn = [IconFont buttonWithIcon:[IconFont icon:key fromFont:@"fontcustom"] fontName:@"fontcustom" size:15.0f color:[UIColor blackColor]];
