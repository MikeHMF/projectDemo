...
- (void)viewDidLoad {
    ...
    self.fontDictionary = [IonViewController dictionaryFromResource:@"ionIcons.json"];
    ...
    for(int i=0;i<self.dataArray.count;i++)
    {
        ...
        UIButton *btn = [IconFont buttonWithIcon:[IconFont icon:key fromFont:@"Ionicons"] fontName:@"Ionicons" size:15.0f color:[UIColor blackColor]];
